...
CREATE TABLE `fa_admin` (
  ...
  `status` varchar(30) NOT NULL DEFAULT 'normal' COMMENT '状态，normal正常',
...
CREATE TABLE `fa_area` (
  ...
  `level` tinyint(4) DEFAULT NULL COMMENT '层级 0 1 2 3 省市区县',
...
CREATE TABLE `fa_auth_group` (
  ...
  `rules` text NOT NULL COMMENT '规则ID，字串拼接',
  `createtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `updatetime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
...
CREATE TABLE `fa_auth_rule` (
  ...
  `status` varchar(30) NOT NULL DEFAULT '' COMMENT '状态,正常normal,隐藏hidden',
...
CREATE TABLE `fa_ems` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `event` varchar(30) NOT NULL DEFAULT '' COMMENT '事件,changeemail修改邮箱,resetpwd重置密码',
...
CREATE TABLE `fa_sms` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `event` varchar(30) NOT NULL DEFAULT '' COMMENT '事件,mobilelogin手机登录,changemobile修改号码,resetpwd重置密码',
...
CREATE TABLE `fa_user` (
  ...
  `status` varchar(30) NOT NULL DEFAULT '' COMMENT '状态,normal正常',
...
CREATE TABLE `fa_user_group` (
  ...
  `status` enum('normal','hidden') DEFAULT NULL COMMENT '状态,normal正常',
...
CREATE TABLE `fa_user_rule` (
  ...
  `status` enum('normal','hidden') DEFAULT NULL COMMENT '状态,normal正常,hidden隐藏',
...
CREATE TABLE `fa_user_token` (
  `token` varchar(50) NOT NULL COMMENT 'Token,加密后的token标识',
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '会员ID',
  `createtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
