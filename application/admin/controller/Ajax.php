...
class Ajax extends Backend
{
    ...
    public function weigh()
    {
        ...
        $field = in_array($field, ['weigh']) ? $field : 'weigh'; //限制更新的字段;
        // 操作的数据表
        ...
        foreach ($list as $k => $v) {
            $sour[] = $v[$prikey];
            $weighdata[$v[$prikey]] = $v[$field]; //权重数据;
        }
        ...
        $weighids = array();
        $temp = array_values(array_diff_assoc($ids, $sour)); //array_diff_assoc — 带索引检查计算数组的差集;
