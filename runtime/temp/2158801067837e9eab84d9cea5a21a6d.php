                    ...
                    <div class="box-body box-profile">
                        ...
                        <div class="profile-avatar-container">
                            <img class="profile-user-img img-responsive img-circle plupload"
                                 src="<?php echo cdnurl($admin['avatar']); ?>" alt="">
                            <div class="profile-avatar-text img-circle"><?php echo __('Click to edit'); ?></div>
                            <button id="plupload-avatar" class="plupload" data-input-id="c-avatar">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="email" name="row[email]"
                                   value="<?php echo $admin['email']; ?>" data-rule="required;email"/>
                        </div>
                        <!-- 昵称 -->
                        <div class="form-group">
                            <label for="nickname" class="control-label"><?php echo __('Nickname'); ?>:</label>
                            <input type="text" class="form-control" id="nickname"
                                   name="row[nickname]" value="<?php echo $admin['nickname']; ?>" data-rule="required"/>
                        </div>
                        <!-- 密码 -->
                        <div class="form-group">
        ...
        <div class="panel panel-default panel-intro panel-nav">
            <div class="panel-heading">
                <ul class="nav nav-tabs">
                    <li class="active">
                        <a href="#one" data-toggle="tab"><i class="fa fa-list"></i> <?php echo __('Admin log'); ?></a>
                    </li>
                </ul>
            </div>
