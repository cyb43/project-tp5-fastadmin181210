<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"/Users/cenyebao/web/project-tp5-fastadmin181210/public/../application/index/view/index/index.html";i:1563559479;}*/ ?>
<!-- ^2_3^ -->
<!DOCTYPE html>
<html>
    <head>
        ...
        <meta name="description" content="2workroom3工作室_FastAdmin项目">
    ...
    <body id="page-top">
                    ...
                    <div class="col-sm-12">
                        <div class="header-content">
                            <div class="header-content-inner">
                                ...
                                <a href="<?php echo url('admin/index/login'); ?>" class="btn btn-warning btn-xl page-scroll">
                                    <?php echo __('Go to Dashboard'); ?></a>
                                <a href="<?php echo url('index/user/index'); ?>" class="btn btn-outline btn-xl page-scroll">
                                    <?php echo __('Go to Member center'); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="cta">
            <div class="cta-content">
                <div class="container">
                    ...
                    <!--<a href="https://doc.fastadmin.net/docs/contributing.html"-->
                       <!--class="btn btn-outline btn-xl page-scroll"><?php echo __('Contribution'); ?></a>-->
                </div>
            </div>
        ...
        <footer>
            <div class="container">
                ...
                <!--<p>&copy; 2017-2018-->
                    <!--<a href="https://www.fastadmin.net" target="_blank">^2_3^_FastAdmin</a>. -->
                    <!--All Rights Reserved.</p>-->
                <p>&copy; 2019
                    <a href="https://cybao.club" target="_blank">^2_3^_FastAdmin</a>. All Rights Reserved.</p>
...
//                    if (!installed) {
//                        $.ajax({
//                            // https://api.fastadmin.net/statistics/installed
