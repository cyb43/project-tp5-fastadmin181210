<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"/Users/cenyebao/web/project-tp5-fastadmin181210/public/../application/index/view/user/login.html";i:1563704122;s:90:"/Users/cenyebao/web/project-tp5-fastadmin181210/application/index/view/layout/default.html";i:1563710415;s:87:"/Users/cenyebao/web/project-tp5-fastadmin181210/application/index/view/common/meta.html";i:1563708693;s:89:"/Users/cenyebao/web/project-tp5-fastadmin181210/application/index/view/common/script.html";i:1563710469;}*/ ?>
<!-- ^2_3^ 前台默认布局 -->
<!DOCTYPE html>
<html>
    <head>
...
<div id="content-container" class="container">
    <div class="user-section login-section">
        <div class="logon-tab clearfix">
            <a class="active"><?php echo __('Sign in'); ?></a>
            <a href="<?php echo url('user/register'); ?>"><?php echo __('Sign up'); ?></a>
        </div>
                ...
                <div class="form-group">
                    <div class="controls">
                        ...
                        <div class="pull-right">
                            <a href="javascript:;" class="btn-forgot"><?php echo __('Forgot password'); ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xs-12 col-sm-8">
                    <div class="radio">
                        <label for="type-email">
                            <input id="type-email" checked="checked" name="type" data-send-url="<?php echo url('api/ems/send'); ?>"
                                   data-check-url="<?php echo url('api/validate/check_ems_correct'); ?>" type="radio"
                                   value="email"> <?php echo __('Reset password by email'); ?>
                        </label>
                        <label for="type-mobile">
                            <input id="type-mobile" name="type" type="radio" data-send-url="<?php echo url('api/sms/send'); ?>"
                                   data-check-url="<?php echo url('api/validate/check_sms_correct'); ?>"
                                   value="mobile"> <?php echo __('Reset password by mobile'); ?>
                        </label>
                    </div>        
                </div>
            </div>
            ...
            <div class="form-group" data-type="email">
                ...
                <div class="col-xs-12 col-sm-8">
                    <input type="text" class="form-control" id="email" name="email" value=""
                           data-rule="required(#type-email:checked);email;
                           remote(<?php echo url('api/validate/check_email_exist'); ?>, event=resetpwd, id=<?php echo $user['id']; ?>)"
                           placeholder="">
            ...
            <div class="form-group hide" data-type="mobile">
                ...
                <div class="col-xs-12 col-sm-8">
                    <input type="text" class="form-control" id="mobile" name="mobile" value=""
                           data-rule="required(#type-mobile:checked);mobile;
                           remote(<?php echo url('api/validate/check_mobile_exist'); ?>, event=resetpwd, id=<?php echo $user['id']; ?>)"
                           placeholder="">
                    <span class="msg-box"></span>
                </div>
            </div>
                ...
                <div class="col-xs-12 col-sm-8">
                    ...
                    <div class="input-group">
                        <input type="text" name="captcha" class="form-control"
                               ...
                               remote(<?php echo url('api/validate/check_ems_correct'); ?>, event=resetpwd, email:#email)" />
                        <span class="input-group-btn" style="padding:0;border:none;">
                            <a href="javascript:;" class="btn btn-info btn-captcha"
                               data-url="<?php echo url('api/ems/send'); ?>" data-type="email"
                               data-event="resetpwd"><?php echo __('Send verification code'); ?></a>
                        </span>
                    </div>
                    <span class="msg-box"></span>
                </div>
