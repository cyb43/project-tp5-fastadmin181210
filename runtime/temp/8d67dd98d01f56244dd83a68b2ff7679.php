                        ...
                        <div class="panel bg-aqua-gradient">
                            <div class="panel-body">
                                ...
                                <div class="ibox-content">
                                    <h1 class="no-margins">0</h1>
                                    <div class="stat-percent font-bold text-gray"><i class="fa fa-modx"></i> 0</div>
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="font-bold">
                                                <!--  评论次数 -->
                                                <i class="fa fa-commenting"></i> <small><?php echo __('Comment count'); ?></small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <h1 class="no-margins">0</h1>
                                            <div class="font-bold">
                                                <!-- 点赞次数 -->
                                                <i class="fa fa-heart"></i> <small><?php echo __('Like count'); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <!-- 点赞次数 -->
                                            <div class="font-bold">
                                                <i class="fa fa-user"></i> <small><?php echo __('Like count'); ?></small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
        ...
        <li class="item">
            <div class="">
                <a href="<%=item.url%>" target="_blank" class="product-title"><%=item.title%>
                    <span class="label label-warning pull-right"><%=item.comments_count%></span>
                </a>
