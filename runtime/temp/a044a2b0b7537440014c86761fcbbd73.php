<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:100:"/Users/cenyebao/web/project-tp5-fastadmin181210/public/../application/admin/view/auth/rule/edit.html";i:1560548269;s:90:"/Users/cenyebao/web/project-tp5-fastadmin181210/application/admin/view/layout/default.html";i:1544409142;s:87:"/Users/cenyebao/web/project-tp5-fastadmin181210/application/admin/view/common/meta.html";i:1562838653;s:89:"/Users/cenyebao/web/project-tp5-fastadmin181210/application/admin/view/auth/rule/tpl.html";i:1560469412;s:89:"/Users/cenyebao/web/project-tp5-fastadmin181210/application/admin/view/common/script.html";i:1562839069;}*/ ?>
<!DOCTYPE html>
...
<form id="edit-form" class="form-horizontal form-ajax" role="form" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input type="text" class="form-control" id="name" name="row[name]" data-placeholder-node="<?php echo __('Node tips'); ?>"
                   data-placeholder-menu="<?php echo __('Menu tips'); ?>" value="<?php echo $row['name']; ?>" data-rule="required" />
        </div>
    </div>
    <!-- 标题 文本框 -->
    <div class="form-group">
