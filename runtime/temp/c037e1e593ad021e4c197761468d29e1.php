                ...
                <div class="widget-body no-padding">
                    ...
                    <div id="toolbar" class="toolbar">
                        ...
                        <a class="btn btn-info btn-disabled disabled btn-selected" href="javascript:;">
                            <i class="fa fa-leaf"></i> 获取选中项</a>
                        <!-- 切换视图 -->
                        <a class="btn btn-success btn-toggle-view" href="javascript:;">
                            <i class="fa fa-leaf"></i> 切换视图</a>
                    </div>
...
<script id="itemtpl" type="text/html">
    ...
    <div class="col-sm-4 col-md-3">
        ...
        <%
            var imagearr = [
                'https://ws2.sinaimg.cn/large/006tNc79gy1fgphwokqt9j30dw0990tb.jpg',
