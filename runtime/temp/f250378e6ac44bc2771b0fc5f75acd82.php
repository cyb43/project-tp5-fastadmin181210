...
<form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-username" data-rule="required" class="form-control"
                   name="row[username]" type="text" value="<?php echo $row['username']; ?>">
        </div>
    </div>
    <!-- 昵称 文本框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-nickname" data-rule="required" class="form-control"
                   name="row[nickname]" type="text" value="<?php echo $row['nickname']; ?>">
        </div>
    </div>
    <!-- 密码 文本框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-password" data-rule="" class="form-control"
                   name="row[password]" type="text" value=""
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-email" data-rule="" class="form-control"
                   name="row[email]" type="text" value="<?php echo $row['email']; ?>">
        </div>
    </div>
    <!-- 手机号 文本框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-mobile" data-rule="" class="form-control"
                   name="row[mobile]" type="text" value="<?php echo $row['mobile']; ?>">
        </div>
    </div>
    <!-- 头像 上传 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-avatar" data-rule="" class="form-control" size="50" name="row[avatar]"
                       type="text" value="<?php echo $row['avatar']; ?>">
                <div class="input-group-addon no-border no-padding">
                    ...
                    <span><button type="button" id="fachoose-avatar" class="btn btn-primary fachoose"
                                  data-input-id="c-avatar" data-mimetype="image/*"
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-level" data-rule="required" class="form-control"
                   name="row[level]" type="number" value="<?php echo $row['level']; ?>">
        </div>
    </div>
    <!-- 性别 单选按钮组 -->
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-birthday" data-rule="" class="form-control datetimepicker"
                   data-date-format="YYYY-MM-DD" data-use-current="true" name="row[birthday]"
                   type="text" value="<?php echo $row['birthday']; ?>">
        </div>
    </div>
    <!-- 格言 文本框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-bio" data-rule="" class="form-control" name="row[bio]"
                   type="text" value="<?php echo $row['bio']; ?>">
        </div>
    </div>
    <!-- 余额 数字框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-money" data-rule="required" class="form-control" name="row[money]"
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-score" data-rule="required" class="form-control" name="row[score]"
                   type="number" value="<?php echo $row['score']; ?>">
        </div>
    </div>
    <!-- 连续登录天数 数字框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-successions" data-rule="required" class="form-control"
                   name="row[successions]" type="number" value="<?php echo $row['successions']; ?>">
        </div>
    </div>
    <!-- 最大连续登录天数 数字框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-maxsuccessions" data-rule="required" class="form-control"
                   name="row[maxsuccessions]" type="number" value="<?php echo $row['maxsuccessions']; ?>">
        </div>
    </div>
    <!-- 上次登录时间 日期时间选择器 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-prevtime" data-rule="required" class="form-control datetimepicker"
                   ...
                   name="row[prevtime]" type="text" value="<?php echo datetime($row['prevtime']); ?>">
        </div>
    </div>
    <!-- 登录时间 日期时间选择器 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-logintime" data-rule="required" class="form-control datetimepicker"
                   data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true"
                   name="row[logintime]" type="text" value="<?php echo datetime($row['logintime']); ?>">
        </div>
    </div>
    <!-- 登录IP 文本框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-loginip" data-rule="required" class="form-control"
                   name="row[loginip]" type="text" value="<?php echo $row['loginip']; ?>">
        </div>
    </div>
    <!-- 失败次数 数字框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-loginfailure" data-rule="required" class="form-control"
                   name="row[loginfailure]" type="number" value="<?php echo $row['loginfailure']; ?>">
        </div>
    </div>
    <!-- 加入IP 文本框 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-joinip" data-rule="required" class="form-control" name="row[joinip]"
                   type="text" value="<?php echo $row['joinip']; ?>">
        </div>
    </div>
    <!-- 加入时间 日期时间选择器 -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-4">
            <input id="c-jointime" data-rule="required" class="form-control datetimepicker"
                   data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true"
                   name="row[jointime]" type="text" value="<?php echo datetime($row['jointime']); ?>">
        </div>
    </div>
    <!-- 状态 单选按钮组 -->
    <div class="form-group">
