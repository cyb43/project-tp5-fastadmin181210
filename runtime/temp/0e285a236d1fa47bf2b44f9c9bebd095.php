...
<form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[hobbydata][]-<?php echo $key; ?>">
                <input id="row[hobbydata][]-<?php echo $key; ?>" name="row[hobbydata][]" type="checkbox" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['hobbydata'])?$row['hobbydata']:explode(',',$row['hobbydata']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?>
            </label>
            <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class='control-relative'>
                <input id="c-city" data-rule="required" class="form-control" data-toggle="city-picker" name="row[city]" type="text" value="<?php echo $row['city']; ?>">
            </div>
        </div>
    </div>
    <!-- 价格 -->
