            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    ...
                    <div id="toolbar" class="toolbar">
                        ...
                        <!-- 地图按钮 -->
                        <a href="example/baidumap/map" class="btn btn-info btn-dialog" title="地图">
                            <i class="fa fa-map-signs"></i> 地图</a>
                    </div>
