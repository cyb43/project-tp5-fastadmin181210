                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="content">
                                <!-- ^2_3^ -->
<style>
    #cxselect-example textarea{margin:10px 0;}
</style>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                            ...
                                            <div class="col-xs-9">
                                                <div class="form-inline" data-toggle="cxselect"
                                                    ...
                                                    <select class="city form-control" name="city"
                                                            data-url="ajax/area"></select>
                                                    <select class="area form-control" name="area"
                                                            data-url="ajax/area"></select>
                                                </div>
                                            </div>
                                            <!-- 添加按钮 -->
                                            <div class="col-xs-3 text-right">
                                                <h6><label class="label label-primary">
                                                    <i class="fa fa-pencil"></i> 增加</label></h6>
                                            </div>
                                            <!-- 代码区域 -->
                                            <div class="col-xs-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- 修改按钮 -->
                                            <div class="col-xs-3 text-right">
                                                <h6><label class="label label-success">
                                                    <i class="fa fa-edit"></i> 修改</label></h6>
                                            </div>
                                            <!-- 代码区域 -->
                                            <div class="col-xs-12">
                                                <textarea class="form-control" rows="8">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-9">
                                                <!-- 分类级联 -->
                                                <div class="form-inline" data-toggle="cxselect"
                                                     data-selects="first,second">
                                                    <select class="first form-control" name="first"
                                                            data-url="ajax/category?type=page&pid=5"></select>
                                                    <select class="second form-control" name="second"
                                                            data-url="ajax/category" data-query-name="pid"></select>
                                                </div>
                                            </div>
                                            <!-- 添加按钮 -->
                                            <div class="col-xs-3 text-right">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-9">
                                                <div class="form-inline" data-toggle="cxselect"
                                                     data-selects="first,second">
                                                    <select class="first form-control" name="first"
                                                            data-url="ajax/category?type=page&pid=5">
                                                        <option value="6" selected>网站建站</option>
                                                    </select>
                                                    <select class="second form-control" name="second"
                                                            data-url="ajax/category" data-query-name="pid">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-9">
                                                ...
                                                <div class="form-inline" data-toggle="cxselect"
                                                     ...
                                                     data-selects="province,city,area" data-json-space=""
                                                     data-json-name="n" data-json-value="">
